...
func TestWriterImplWriteWithoutImpl(t *testing.T) {
	err := *new(error)
	val := 0
...
func TestWriteCloserImplWriteWithoutImpl(t *testing.T) {
	err := *new(error)
	val := 0
...
func TestWriteCloserImplCloseWithoutImpl(t *testing.T) {
	wc := WriteCloserImpl[int]{}
...
func TestNewWriterFromBytesWithNilDecoder(t *testing.T) {
	...
	gob.NewEncoder(w).Encode(2)
	gob.NewEncoder(w).Encode(3)
...
func TestWriterWithFilterFnIdeal(t *testing.T) {
	s := make([]int, 0, 2)
...
func TestWriterWithFilterFnWithNilWriter(t *testing.T) {
...
func TestWriterWithFilterFnWithNilFilter(t *testing.T) {
	s := make([]int, 0, 2)
